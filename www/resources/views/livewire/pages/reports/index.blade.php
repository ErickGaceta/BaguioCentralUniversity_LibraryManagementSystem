<div class="flex flex-col gap-4 p-4">
    ...
    <div class="flex gap-3 sm:flex-row sm:items-center">
        ...
        <div class="flex gap-2">
            <flux:modal.trigger name="generate-report">
                <flux:button variant="primary" icon="clipboard-document-list" color="amber"
                    class="hover:opacity-90 transition shrink-0" x-on:click="$flux.modal('generate-report').show()">
                    Generate Report
                </flux:button>
            </flux:modal.trigger>
                                ...
                                <flux:table.cell>
                                    <div class="flex items-center gap-1 justify-end">
                                        ...
                                        <flux:button size="sm" variant="ghost" icon="trash" title="Delete report"
                                            x-on:click="$flux.modal('delete-report').show(); $wire.set('deletingId', {{ $report->id }})" />
    ...
    <x-confirm-modal name="delete-report" title="Delete Report"
        description="This will permanently delete this report. This action cannot be undone. Continue?"
        confirm-label="Delete" confirm-action="deleteConfirmed" />
