    ...
    <div class="flex flex-col gap-4">
        ...
        @if(!empty($selectedIds))
            <div
                ...
                <flux:spacer />
                <flux:button variant="danger" size="sm" icon="trash" x-on:click="$flux.modal('delete-users-bulk').show()">
                    Delete Selected
                </flux:button>
            </div>
        @endif
                            ...
                            <flux:table.cell align="end">
                                <div class="flex gap-1 justify-end">
                                    ...
                                    <flux:button icon="trash" size="sm" variant="danger"
                                        x-on:click="$wire.set('deletingId', {{ $user->id }}); $wire.set('deletingUserType', 'student'); $flux.modal('delete-user').show()" />
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @empty
                        ...
                        <flux:table.row>
                            ...
                            <flux:table.cell align="end">
                                <div class="flex gap-1 justify-end">
                                    ...
                                    {{-- Single permanent delete --}}
                                    <flux:button icon="trash" size="sm" variant="danger"
                                        x-on:click="$wire.set('deletingId', {{ $user->id }}); $wire.set('deletingUserType', 'faculty'); $flux.modal('delete-user').show()" />
                                </div>
                            </flux:table.cell>
                        </flux:table.row>
                    @empty
